    ...
    $.initEchartsMap = function (arg) {
        ...
        if(arg.nameArray !=undefined && arg.nameArray.length>0){
            $.each(nameArray, function(i,o) {
                ...
                console.log(arg.dataArray[i]);
                $.each(arg.dataArray[i],function (i , o) {
        ...
        var option={
            ...
            tooltip: {
                trigger: 'item',
                formatter: arg.nameArray[0]+' <br/>{b}: {c}'
            },
            visualMap: {
                min: arg.minNumber,
                max: arg.maxNumber,
            ...
            graphic: [
                {
                    ...
                    style: {
                        fill: '#333',
                        text: '全国'+arg.nameArray[0]+" "+dataAll,
